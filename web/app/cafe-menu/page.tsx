...
//   },
//   {
//     image: "/assets/images/home/cream-cloud-latte.jpeg",
//     alt: "Cream Cloud Latte",
//     title: "Cream Cloud Latte",
//     price: "$7.50"
//   },
//   {
//     image: "/assets/images/home/chocolate-cloud-latte.webp",
    ...
    <>
      ...
      <main id="main-content" className="page-shell page-shell-design menu-page menu-sheet-page menu-reference-page">
        <section className="sheet-hero menu-sheet-hero reveal" aria-labelledby="menu-title">
          ...
          <Divider />
          <p>Handcrafted drinks and indulgent bites made with love</p>
          <div className="group-tabs design-tabs" aria-label="Menu group">
            <a className="group-tab is-active" href="#coffee">Coffee</a>
            <a className="group-tab" href="#non-coffee">Non Coffee</a>
            <a className="group-tab" href="#savoury">Savoury</a>
            <a className="group-tab" href="#pastries">Pastries</a>
          </div>
        </section>
{/* 
        <section id="coffee" className="menu-panel reveal" aria-labelledby="coffee">
          <h2 id="coffee"><i className="detail-icon ri-cloud-line" aria-hidden="true" />Coffee</h2>
        ...
        <section id="non-coffee" className="menu-panel reveal" aria-labelledby="non-coffee">
          <h2 id="non-coffee"><i className="detail-icon ri-cloud-line" aria-hidden="true" />Non Coffee</h2>
          <div className="cloud-card-grid">
            {cloudDrinks.map((drink) => (
              <article className="sheet-product-card" key={drink.title}>
                <img src={drink.image} alt={drink.alt} />
        ...
        {/* <section id="coffee" className="menu-panel split-menu-panel menu-list-photo-panel menu-list-photo-right reveal" aria-labelledby="coffee-title">
          <div>
        ...
        <section id="non-coffee" className="menu-panel split-menu-panel menu-list-photo-panel menu-list-photo-right reveal" aria-labelledby="non-coffee-title">
          <h2 id="non-coffee-title"><i className="detail-icon ri-cup-line" aria-hidden="true" />Non-Coffee</h2>
          <img src="/assets/images/menu/reference/coffee-latte.jpeg" alt="Latte art coffee" />
          <div className="menu-list-copy">
            <PriceList items={nonCoffees} ruled />
          </div>
          <span className="menu-panel-arrow" aria-hidden="true">›</span>
        </section>

        <section id="savoury" className="menu-panel split-menu-panel menu-list-photo-panel menu-list-photo-right reveal" aria-labelledby="savoury-title">
